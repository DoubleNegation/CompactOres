...
public class CompactOreBlock extends Block {
    ...
    public CompactOreBlock(Block baseBlock) {
        super(Properties.create(Material.ROCK).sound(SoundType.STONE));
        this.baseBlock = baseBlock;
        setRegistryName(new ResourceLocation("compactores", "compact_" + baseBlock.getRegistryName().getNamespace() + "_" +
                baseBlock.getRegistryName().getPath()));
    }
